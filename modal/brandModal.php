    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitBrandForm" action="php_action/createBrand.php" method="POST">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Agregar Proveedores </h4>
	      </div>
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="rif" placeholder="RIF del proveedor" name="rif" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	         	        
	        <div class="form-group">
    	...
    	<form class="form-horizontal" id="editBrandForm" action="php_action/editBrand.php" method="POST">
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-brand-result">
		        ...
		        <div class="form-group">
		        	<label for="editRif" class="col-sm-3 control-label">RIF: </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="editRif" placeholder="RIF del proveedor" name="editRif" autocomplete="off" required>
					    </div>
		        </div> <!-- /form-group-->	         	        
		        <div class="form-group">
