...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-08-2025 a las 01:32:12
...
(1, 'Polo', '75527577', 1, 1),
(3, 'EMINENT', '82545631', 2, 2),
(4, 'Inversiones Quero Jimenez', '40242437-0', 1, 1);
...
(7, 'FACTURA PRIDE.pdf', 'invoices/688c13cf32ca53.00042413.pdf', '2025-08-01 01:09:35', '25000372', '00017146');
...
(4, 'Pride Natural 360 ML', '../assests/images/stock/2117693479688c110cc2468.jpg', 4, 6, '9', '12', 1, 1);
...
(NULL, 4, 1, '2025-07-31', 'Brayan Herrera', 'Plata la California', 'Para uso de Tecnologia'),
(NULL, 4, 1, '2025-07-31', 'Brayan Herrera', 'Planta Turmero', 'Para uso de Tecnologia'),
(NULL, 4, 1, '2025-07-31', 'Brayan Herrera', 'Chuao', 'Para uso de Tecnologia');
...
CREATE TABLE `users` (
  ...
  `role` int(11) NOT NULL DEFAULT 3 COMMENT '1=SuperAdmin, 2=Admin, 3=Visualizer'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `users` (`user_id`, `username`, `password`, `active`, `role`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, 1),
(3, 'bherrera', 'c4ca4238a0b923820dcc509a6f75849b', 1, 2),
(7, 'jonieves', 'c4ca4238a0b923820dcc509a6f75849b', 1, 2);
